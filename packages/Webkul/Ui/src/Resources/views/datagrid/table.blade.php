            ...
            <div class="grid-container">
                ...
                <div class="filter-row-one" id="datagrid-filters">
                    ...
                    <div class="search-filter">
                        <input type="search"  id="search-field" class=" border-t border-b control form-control subscribe-field form-sub" placeholder="{{ __('ui::app.datagrid.search') }}" v-model="searchValue" v-on:keyup.enter="searchCollection(searchValue)" />
                            ...
                            <ul>
                                <li>
                                    <div class="control-group">
                                        <select name="Filter" data-vv-as="Filter" class="filter-column-select control" v-model="filterColumn" v-on:click="getColumnOrAlias(filterColumn)">
                    ...
                    <div class="dropdown-filters per-page">
                        <div class="control-group">
                            ...
                            <select id="perPage" name="perPage" class="c-form control  border-b" v-model="perPage" v-on:change="paginate">
