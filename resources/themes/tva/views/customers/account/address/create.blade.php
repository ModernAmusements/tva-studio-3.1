...
<div class="bread-crumbs">
    ...
    <div class="account-content">
        ...
        <div class="account-layout">
            <div class="heading">
                <h2 class="single-line">{{ __('shop::app.customer.account.address.create.title') }}</h2>
            </div>
            ...
            <form id="customer-address-form" method="post" action="{{ route('customer.address.create') }}" @submit.prevent="onSubmit">
                ...
                <div class="account-table-content">
                    ...
                    <div class="button-group btn-grid border-t  border-b btn-grid-primary">
                        <button class="btn-hover" type="submit" value="{{ __('shop::app.customer.account.address.create.submit') }}">
                            <span>
