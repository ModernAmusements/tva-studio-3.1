<form data-vv-scope="address-form">
    ...
    <div class="form-container" v-if="this.new_billing_address">
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[company_name]') ? 'has-error' : '']">
            ...
            <input type="text" class="control form-control subscribe-field form-sub" id="billing[company_name]" name="billing[company_name]" v-model="address.billing.company_name" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.company-name') }}&quot;"/>
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[first_name]') ? 'has-error' : '']">
            ...
            <input type="text" v-validate="'required'" class="control form-control subscribe-field form-sub" id="billing[first_name]" name="billing[first_name]" v-model="address.billing.first_name" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.first-name') }}&quot;"/>
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[last_name]') ? 'has-error' : '']">
            ...
            <input type="text" v-validate="'required'" class="control form-control subscribe-field form-sub" id="billing[last_name]" name="billing[last_name]" v-model="address.billing.last_name" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.last-name') }}&quot;"/>
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[address1][]') ? 'has-error' : '']">
            ...
            <input type="text" v-validate="'required'" class="control form-control subscribe-field form-sub" id="billing_address_0" name="billing[address1][]" v-model="address.billing.address1[0]" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.address1') }}&quot;"/>
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[city]') ? 'has-error' : '']">
            ...
            <input type="text" v-validate="'required'" class="control form-control subscribe-field form-sub" id="billing[city]" name="billing[city]" v-model="address.billing.city" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.city') }}&quot;"/>
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[country]') ? 'has-error' : '']">
            ...
            <select type="text" v-validate="'required'" class="c-form control" id="billing[country]" name="billing[country]" v-model="address.billing.country" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.country') }}&quot;">
                <option value=""></option>
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[postcode]') ? 'has-error' : '']">
            ...
            <input type="text" v-validate="'required'" class="control form-control subscribe-field form-sub" id="billing[postcode]" name="billing[postcode]" v-model="address.billing.postcode" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.postcode') }}&quot;"/>
        ...
        <div class="control-group" :class="[errors.has('address-form.billing[phone]') ? 'has-error' : '']">
            ...
            <input type="text" v-validate="'required'" class="control form-control subscribe-field form-sub" id="billing[phone]" name="billing[phone]" v-model="address.billing.phone" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.phone') }}&quot;"/>
    ...
    @if ($cart->haveStockableItems())
        ...
        <div class="form-container" v-if="!address.billing.use_for_shipping && this.new_shipping_address">
            ...
            @if (core()->getConfigData('customer.settings.address.street_lines') && core()->getConfigData('customer.settings.address.street_lines') > 1)
                <div class="control-group" style="margin-top: -25px;">
                    @for ($i = 1; $i < core()->getConfigData('customer.settings.address.street_lines'); $i++)
                        <input type="text" class="control form-control subscribe-field form-sub" name="shipping[address1][{{ $i }}]" id="shipping_address_{{ $i }}" v-model="address.shipping.address1[{{$i}}]">
                    @endfor
                </div>
            @endif
